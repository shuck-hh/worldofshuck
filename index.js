    ...
    filtered.forEach(repo => {
      ...
      <div class="card__descr-wrapper">
        ...
        <div class="card__links">
          <div>
            ${preview_svg}
            <a class="link" href="${repo.homepage || repo.html_url}" target="_blank">
              Preview
            </a>
          </div>
          <div>
